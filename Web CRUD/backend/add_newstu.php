...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO assignedstu (ins_subcode, stu_id, stu_fname, stu_lname, stu_mname, stu_program, stu_year, stu_grade)
    VALUES ('$ins_subcode', ' $stu_id', ' $stu_fname', '  $stu_lname', ' $stu_mname', '  $stu_program', '$stu_year', '   $stu_grade')";
